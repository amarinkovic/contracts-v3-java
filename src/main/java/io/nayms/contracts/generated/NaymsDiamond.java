...
public class NaymsDiamond extends Contract {
    ...
    public static final String FUNC_ACCRUEDINTEREST = "accruedInterest";
    ...
    public static final String FUNC_APPROVESELFONBOARDING = "approveSelfOnboarding";
    ...
    public static final String FUNC_CALCULATESTARTTIMEOFCURRENTINTERVAL = "calculateStartTimeOfCurrentInterval";

    public static final String FUNC_CALCULATESTARTTIMEOFINTERVAL = "calculateStartTimeOfInterval";
    ...
    public static final String FUNC_CANCELSELFONBOARDING = "cancelSelfOnboarding";
    ...
    public static final String FUNC_COLLECTREWARDSTOINTERVAL = "collectRewardsToInterval";
    ...
    public static final String FUNC_CURRENTINTERVAL = "currentInterval";

    public static final String FUNC_DISTRIBUTEACCRUEDINTEREST = "distributeAccruedInterest";
    ...
    public static final String FUNC_GETREWARDSBALANCE = "getRewardsBalance";
    ...
    public static final String FUNC_GETSTAKINGAMOUNTS = "getStakingAmounts";

    public static final String FUNC_GETSTAKINGCONFIG = "getStakingConfig";
    ...
    public static final String FUNC_INITSTAKING = "initStaking";
    ...
    public static final String FUNC_ISSELFONBOARDINGAPPROVED = "isSelfOnboardingApproved";
    ...
    public static final String FUNC_LASTCOLLECTEDINTERVAL = "lastCollectedInterval";

    public static final String FUNC_LASTPAIDINTERVAL = "lastPaidInterval";
    ...
    public static final String FUNC_OBJECTMINIMUMSELL = "objectMinimumSell";

    public static final String FUNC_ONBOARD = "onboard";
    ...
    public static final String FUNC_SETEXISTINGOBJECTS = "setExistingObjects";

    public static final String FUNC_SETMAXDIVIDENDDENOMINATIONS = "setMaxDividendDenominations";

    public static final String FUNC_SETMINIMUMSELL = "setMinimumSell";
    ...
    public static final String FUNC_VTOKENID = "vTokenId";
    ...
    public static final Event EXTERNALDEPOSIT_EVENT = new Event("ExternalDeposit", 
            Arrays.<TypeReference<?>>asList(new TypeReference<Bytes32>() {}, new TypeReference<Address>() {}, new TypeReference<Uint256>() {}));
    ;

    public static final Event EXTERNALWITHDRAW_EVENT = new Event("ExternalWithdraw", 
    ...
    public static final Event TOKENREWARDCOLLECTED_EVENT = new Event("TokenRewardCollected", 
            Arrays.<TypeReference<?>>asList(new TypeReference<Bytes32>(true) {}, new TypeReference<Bytes32>() {}, new TypeReference<Bytes32>() {}, new TypeReference<Uint64>() {}, new TypeReference<Bytes32>() {}, new TypeReference<Uint256>() {}));
    ;

    public static final Event TOKENREWARDPAID_EVENT = new Event("TokenRewardPaid", 
            Arrays.<TypeReference<?>>asList(new TypeReference<Bytes32>() {}, new TypeReference<Bytes32>() {}, new TypeReference<Bytes32>() {}, new TypeReference<Bytes32>() {}, new TypeReference<Uint256>() {}));
    ;

    public static final Event TOKENSTAKED_EVENT = new Event("TokenStaked", 
            Arrays.<TypeReference<?>>asList(new TypeReference<Bytes32>(true) {}, new TypeReference<Bytes32>() {}, new TypeReference<Bytes32>() {}, new TypeReference<Uint256>() {}));
    ;

    public static final Event TOKENSTAKINGSTARTED_EVENT = new Event("TokenStakingStarted", 
            Arrays.<TypeReference<?>>asList(new TypeReference<Bytes32>(true) {}, new TypeReference<Bytes32>() {}, new TypeReference<Uint256>() {}, new TypeReference<Uint64>() {}, new TypeReference<Uint64>() {}, new TypeReference<Uint64>() {}, new TypeReference<Uint64>() {}));
    ;

    public static final Event TOKENUNSTAKED_EVENT = new Event("TokenUnstaked", 
            Arrays.<TypeReference<?>>asList(new TypeReference<Bytes32>(true) {}, new TypeReference<Bytes32>() {}, new TypeReference<Bytes32>() {}, new TypeReference<Uint256>() {}));
    ;
    ...
    public static final Event MINIMUMSELLUPDATED_EVENT = new Event("MinimumSellUpdated", 
    ...
    public static final Event ORDERMATCHED_EVENT = new Event("OrderMatched", 
    ...
    public static final Event FEESCHEDULEREMOVED_EVENT = new Event("FeeScheduleRemoved", 
            Arrays.<TypeReference<?>>asList(new TypeReference<Bytes32>() {}, new TypeReference<Uint256>() {}));
    ;
    ...
    public static final Event OBJECTMINIMUMSELLUPDATED_EVENT = new Event("ObjectMinimumSellUpdated", 
            Arrays.<TypeReference<?>>asList(new TypeReference<Bytes32>() {}, new TypeReference<Uint256>() {}));
    ;

    public static final Event SELFONBOARDINGAPPROVED_EVENT = new Event("SelfOnboardingApproved", 
            Arrays.<TypeReference<?>>asList(new TypeReference<Address>(true) {}));
    ;

    public static final Event SELFONBOARDINGCANCELLED_EVENT = new Event("SelfOnboardingCancelled", 
            Arrays.<TypeReference<?>>asList(new TypeReference<Address>(true) {}));
    ;

    public static final Event SELFONBOARDINGCOMPLETED_EVENT = new Event("SelfOnboardingCompleted", 
            Arrays.<TypeReference<?>>asList(new TypeReference<Address>(true) {}));
    ;
    ...
    public RemoteFunctionCall<Uint256> accruedInterest(Bytes32 _tokenId) {
        final Function function = new Function(FUNC_ACCRUEDINTEREST, 
    ...
    public RemoteFunctionCall<TransactionReceipt> addSupportedExternalToken(Address _tokenAddress, Uint256 _minimumSell) {
        final Function function = new Function(
                FUNC_ADDSUPPORTEDEXTERNALTOKEN, 
                Arrays.<Type>asList(_tokenAddress, _minimumSell), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }

    public RemoteFunctionCall<TransactionReceipt> approveSelfOnboarding(Address _userAddress, Bytes32 _entityId, Bytes32 _roleId) {
        final Function function = new Function(
                FUNC_APPROVESELFONBOARDING, 
                Arrays.<Type>asList(_userAddress, _entityId, _roleId), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteFunctionCall<Uint256> calculateStartTimeOfCurrentInterval(Bytes32 _entityId) {
        final Function function = new Function(FUNC_CALCULATESTARTTIMEOFCURRENTINTERVAL, 
                Arrays.<Type>asList(_entityId), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Uint256>() {}));
        return executeRemoteCallSingleValueReturn(function);
    }

    public RemoteFunctionCall<Uint256> calculateStartTimeOfInterval(Bytes32 _entityId, Uint64 _interval) {
        final Function function = new Function(FUNC_CALCULATESTARTTIMEOFINTERVAL, 
                Arrays.<Type>asList(_entityId, _interval), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Uint256>() {}));
        return executeRemoteCallSingleValueReturn(function);
    }
    ...
    public RemoteFunctionCall<TransactionReceipt> cancelSelfOnboarding(Address _user) {
        final Function function = new Function(
                FUNC_CANCELSELFONBOARDING, 
    ...
    public RemoteFunctionCall<TransactionReceipt> collectRewards(Bytes32 _entityId) {
        final Function function = new Function(
                FUNC_COLLECTREWARDS, 
                Arrays.<Type>asList(_entityId), 
                Collections.<TypeReference<?>>emptyList());
    ...
    public RemoteFunctionCall<TransactionReceipt> collectRewardsToInterval(Bytes32 _entityId, Uint64 _interval) {
        final Function function = new Function(
                FUNC_COLLECTREWARDSTOINTERVAL, 
                Arrays.<Type>asList(_entityId, _interval), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteFunctionCall<Uint64> currentInterval(Bytes32 _entityId) {
        final Function function = new Function(FUNC_CURRENTINTERVAL, 
                Arrays.<Type>asList(_entityId), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Uint64>() {}));
        return executeRemoteCallSingleValueReturn(function);
    }

    public RemoteFunctionCall<TransactionReceipt> distributeAccruedInterest(Bytes32 _tokenId, Uint256 _amount, Bytes32 _guid) {
        final Function function = new Function(
                FUNC_DISTRIBUTEACCRUEDINTEREST, 
                Arrays.<Type>asList(_tokenId, _amount, _guid), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteFunctionCall<TransactionReceipt> enableEntityTokenization(Bytes32 _objectId, Utf8String _symbol, Utf8String _name, Uint256 _minimumSell) {
        final Function function = new Function(
                FUNC_ENABLEENTITYTOKENIZATION, 
                Arrays.<Type>asList(_objectId, _symbol, _name, _minimumSell), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteFunctionCall<Tuple2<DynamicArray<Bytes32>, DynamicArray<Uint16>>> getFeeSchedule(Bytes32 _entityId, Uint256 _feeScheduleType) {
        ...
        return new RemoteFunctionCall<Tuple2<DynamicArray<Bytes32>, DynamicArray<Uint16>>>(function,
    ...
    public RemoteFunctionCall<Tuple2<DynamicArray<Bytes32>, DynamicArray<Uint256>>> getRewardsBalance(Bytes32 _stakerId, Bytes32 _entityId) {
        final Function function = new Function(FUNC_GETREWARDSBALANCE, 
                Arrays.<Type>asList(_stakerId, _entityId), 
                Arrays.<TypeReference<?>>asList(new TypeReference<DynamicArray<Bytes32>>() {}, new TypeReference<DynamicArray<Uint256>>() {}));
        return new RemoteFunctionCall<Tuple2<DynamicArray<Bytes32>, DynamicArray<Uint256>>>(function,
    ...
    public RemoteFunctionCall<Tuple2<Uint256, Uint256>> getStakingAmounts(Bytes32 _stakerId, Bytes32 _entityId) {
        final Function function = new Function(FUNC_GETSTAKINGAMOUNTS, 
                Arrays.<Type>asList(_stakerId, _entityId), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Uint256>() {}, new TypeReference<Uint256>() {}));
        return new RemoteFunctionCall<Tuple2<Uint256, Uint256>>(function,
                new Callable<Tuple2<Uint256, Uint256>>() {
    ...
    public RemoteFunctionCall<StakingConfig> getStakingConfig(Bytes32 _entityId) {
        final Function function = new Function(FUNC_GETSTAKINGCONFIG, 
                Arrays.<Type>asList(_entityId), 
                Arrays.<TypeReference<?>>asList(new TypeReference<StakingConfig>() {}));
        return executeRemoteCallSingleValueReturn(function);
    }
    ...
    public RemoteFunctionCall<TransactionReceipt> initStaking(Bytes32 _entityId, StakingConfig _config) {
        final Function function = new Function(
                FUNC_INITSTAKING, 
                Arrays.<Type>asList(_entityId, _config), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteFunctionCall<TransactionReceipt> internalTransferBySystemAdmin(Bytes32 _fromId, Bytes32 _toId, Bytes32 _tokenId, Uint256 _amount) {
        final Function function = new Function(
                FUNC_INTERNALTRANSFERBYSYSTEMADMIN, 
                Arrays.<Type>asList(_fromId, _toId, _tokenId, _amount), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteFunctionCall<Bool> isSelfOnboardingApproved(Address _userAddress, Bytes32 _entityId, Bytes32 _roleId) {
        final Function function = new Function(FUNC_ISSELFONBOARDINGAPPROVED, 
                Arrays.<Type>asList(_userAddress, _entityId, _roleId), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Bool>() {}));
        return executeRemoteCallSingleValueReturn(function);
    }
    ...
    public RemoteFunctionCall<Uint64> lastCollectedInterval(Bytes32 _entityId, Bytes32 _stakerId) {
        final Function function = new Function(FUNC_LASTCOLLECTEDINTERVAL, 
                Arrays.<Type>asList(_entityId, _stakerId), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Uint64>() {}));
        return executeRemoteCallSingleValueReturn(function);
    }

    public RemoteFunctionCall<Uint64> lastPaidInterval(Bytes32 _entityId) {
        final Function function = new Function(FUNC_LASTPAIDINTERVAL, 
                Arrays.<Type>asList(_entityId), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Uint64>() {}));
        return executeRemoteCallSingleValueReturn(function);
    }
    ...
    public RemoteFunctionCall<Uint256> objectMinimumSell(Bytes32 _objectId) {
        final Function function = new Function(FUNC_OBJECTMINIMUMSELL, 
                Arrays.<Type>asList(_objectId), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Uint256>() {}));
        return executeRemoteCallSingleValueReturn(function);
    }

    public RemoteFunctionCall<TransactionReceipt> onboard() {
        final Function function = new Function(
                FUNC_ONBOARD, 
                Arrays.<Type>asList(), 
                Collections.<TypeReference<?>>emptyList());
    ...
    public RemoteFunctionCall<TransactionReceipt> payReward(Bytes32 _stakingRewardId, Bytes32 _entityId, Bytes32 _rewardTokenId, Uint256 _amount) {
        final Function function = new Function(
                FUNC_PAYREWARD, 
                Arrays.<Type>asList(_stakingRewardId, _entityId, _rewardTokenId, _amount), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteFunctionCall<TransactionReceipt> setExistingObjects(DynamicArray<Bytes32> _id, Bool _isExisting) {
        final Function function = new Function(
                FUNC_SETEXISTINGOBJECTS, 
                Arrays.<Type>asList(_id, _isExisting), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteFunctionCall<TransactionReceipt> setMinimumSell(Bytes32 _objectId, Uint256 _minimumSell) {
        final Function function = new Function(
                FUNC_SETMINIMUMSELL, 
                Arrays.<Type>asList(_objectId, _minimumSell), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }

    public RemoteFunctionCall<TransactionReceipt> stake(Bytes32 _entityId, Uint256 _amount) {
        final Function function = new Function(
                FUNC_STAKE, 
                Arrays.<Type>asList(_entityId, _amount), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteFunctionCall<TransactionReceipt> unstake(Bytes32 _entityId) {
        final Function function = new Function(
                FUNC_UNSTAKE, 
                Arrays.<Type>asList(_entityId), 
                Collections.<TypeReference<?>>emptyList());
    ...
    public RemoteFunctionCall<Bytes32> vTokenId(Bytes32 _entityId, Bytes32 _tokenId, Uint64 _interval) {
        final Function function = new Function(FUNC_VTOKENID, 
                Arrays.<Type>asList(_entityId, _tokenId, _interval), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Bytes32>() {}));
        return executeRemoteCallSingleValueReturn(function);
    }
    ...
    public static List<ExternalDepositEventResponse> getExternalDepositEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = staticExtractEventParametersWithLog(EXTERNALDEPOSIT_EVENT, transactionReceipt);
        ArrayList<ExternalDepositEventResponse> responses = new ArrayList<ExternalDepositEventResponse>(valueList.size());
        for (Contract.EventValuesWithLog eventValues : valueList) {
            ExternalDepositEventResponse typedResponse = new ExternalDepositEventResponse();
            typedResponse.log = eventValues.getLog();
            typedResponse.receiverId = (Bytes32) eventValues.getNonIndexedValues().get(0);
            typedResponse.externalTokenAddress = (Address) eventValues.getNonIndexedValues().get(1);
    ...
    public static ExternalDepositEventResponse getExternalDepositEventFromLog(Log log) {
        Contract.EventValuesWithLog eventValues = staticExtractEventParametersWithLog(EXTERNALDEPOSIT_EVENT, log);
        ExternalDepositEventResponse typedResponse = new ExternalDepositEventResponse();
        typedResponse.log = log;
        typedResponse.receiverId = (Bytes32) eventValues.getNonIndexedValues().get(0);
        typedResponse.externalTokenAddress = (Address) eventValues.getNonIndexedValues().get(1);
    ...
    public Flowable<ExternalDepositEventResponse> externalDepositEventFlowable(EthFilter filter) {
        return web3j.ethLogFlowable(filter).map(log -> getExternalDepositEventFromLog(log));
    }

    public Flowable<ExternalDepositEventResponse> externalDepositEventFlowable(DefaultBlockParameter startBlock, DefaultBlockParameter endBlock) {
        EthFilter filter = new EthFilter(startBlock, endBlock, getContractAddress());
        filter.addSingleTopic(EventEncoder.encode(EXTERNALDEPOSIT_EVENT));
        return externalDepositEventFlowable(filter);
    }

    public static List<ExternalWithdrawEventResponse> getExternalWithdrawEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = staticExtractEventParametersWithLog(EXTERNALWITHDRAW_EVENT, transactionReceipt);
        ArrayList<ExternalWithdrawEventResponse> responses = new ArrayList<ExternalWithdrawEventResponse>(valueList.size());
        for (Contract.EventValuesWithLog eventValues : valueList) {
            ExternalWithdrawEventResponse typedResponse = new ExternalWithdrawEventResponse();
            typedResponse.log = eventValues.getLog();
            ...
            typedResponse.externalTokenAddress = (Address) eventValues.getNonIndexedValues().get(2);
    ...
    public static ExternalWithdrawEventResponse getExternalWithdrawEventFromLog(Log log) {
        Contract.EventValuesWithLog eventValues = staticExtractEventParametersWithLog(EXTERNALWITHDRAW_EVENT, log);
        ExternalWithdrawEventResponse typedResponse = new ExternalWithdrawEventResponse();
        typedResponse.log = log;
        typedResponse.entityId = (Bytes32) eventValues.getNonIndexedValues().get(0);
        typedResponse.receiver = (Address) eventValues.getNonIndexedValues().get(1);
    ...
    public Flowable<ExternalWithdrawEventResponse> externalWithdrawEventFlowable(EthFilter filter) {
        return web3j.ethLogFlowable(filter).map(log -> getExternalWithdrawEventFromLog(log));
    }

    public Flowable<ExternalWithdrawEventResponse> externalWithdrawEventFlowable(DefaultBlockParameter startBlock, DefaultBlockParameter endBlock) {
        EthFilter filter = new EthFilter(startBlock, endBlock, getContractAddress());
        filter.addSingleTopic(EventEncoder.encode(EXTERNALWITHDRAW_EVENT));
        return externalWithdrawEventFlowable(filter);
    }
    ...
    public static List<TokenRewardCollectedEventResponse> getTokenRewardCollectedEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = staticExtractEventParametersWithLog(TOKENREWARDCOLLECTED_EVENT, transactionReceipt);
        ArrayList<TokenRewardCollectedEventResponse> responses = new ArrayList<TokenRewardCollectedEventResponse>(valueList.size());
        for (Contract.EventValuesWithLog eventValues : valueList) {
            TokenRewardCollectedEventResponse typedResponse = new TokenRewardCollectedEventResponse();
            typedResponse.log = eventValues.getLog();
            typedResponse.stakerId = (Bytes32) eventValues.getIndexedValues().get(0);
            typedResponse.entityId = (Bytes32) eventValues.getNonIndexedValues().get(0);
            typedResponse.tokenId = (Bytes32) eventValues.getNonIndexedValues().get(1);
            typedResponse.interval = (Uint64) eventValues.getNonIndexedValues().get(2);
            typedResponse.rewardCurrency = (Bytes32) eventValues.getNonIndexedValues().get(3);
            typedResponse.rewardAmount = (Uint256) eventValues.getNonIndexedValues().get(4);
            responses.add(typedResponse);
        }
        return responses;
    }

    public static TokenRewardCollectedEventResponse getTokenRewardCollectedEventFromLog(Log log) {
        Contract.EventValuesWithLog eventValues = staticExtractEventParametersWithLog(TOKENREWARDCOLLECTED_EVENT, log);
        TokenRewardCollectedEventResponse typedResponse = new TokenRewardCollectedEventResponse();
        typedResponse.log = log;
        typedResponse.stakerId = (Bytes32) eventValues.getIndexedValues().get(0);
        typedResponse.entityId = (Bytes32) eventValues.getNonIndexedValues().get(0);
    ...
    public Flowable<TokenRewardCollectedEventResponse> tokenRewardCollectedEventFlowable(EthFilter filter) {
        return web3j.ethLogFlowable(filter).map(log -> getTokenRewardCollectedEventFromLog(log));
    }

    public Flowable<TokenRewardCollectedEventResponse> tokenRewardCollectedEventFlowable(DefaultBlockParameter startBlock, DefaultBlockParameter endBlock) {
        EthFilter filter = new EthFilter(startBlock, endBlock, getContractAddress());
        filter.addSingleTopic(EventEncoder.encode(TOKENREWARDCOLLECTED_EVENT));
        return tokenRewardCollectedEventFlowable(filter);
    }

    public static List<TokenRewardPaidEventResponse> getTokenRewardPaidEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = staticExtractEventParametersWithLog(TOKENREWARDPAID_EVENT, transactionReceipt);
        ArrayList<TokenRewardPaidEventResponse> responses = new ArrayList<TokenRewardPaidEventResponse>(valueList.size());
        for (Contract.EventValuesWithLog eventValues : valueList) {
            TokenRewardPaidEventResponse typedResponse = new TokenRewardPaidEventResponse();
            typedResponse.log = eventValues.getLog();
            typedResponse.guid = (Bytes32) eventValues.getNonIndexedValues().get(0);
            typedResponse.entityId = (Bytes32) eventValues.getNonIndexedValues().get(1);
            typedResponse.tokenId = (Bytes32) eventValues.getNonIndexedValues().get(2);
            typedResponse.rewardTokenId = (Bytes32) eventValues.getNonIndexedValues().get(3);
            typedResponse.rewardAmount = (Uint256) eventValues.getNonIndexedValues().get(4);
            responses.add(typedResponse);
        }
        return responses;
    ...
    public static TokenRewardPaidEventResponse getTokenRewardPaidEventFromLog(Log log) {
        Contract.EventValuesWithLog eventValues = staticExtractEventParametersWithLog(TOKENREWARDPAID_EVENT, log);
        TokenRewardPaidEventResponse typedResponse = new TokenRewardPaidEventResponse();
        typedResponse.log = log;
        typedResponse.guid = (Bytes32) eventValues.getNonIndexedValues().get(0);
        typedResponse.entityId = (Bytes32) eventValues.getNonIndexedValues().get(1);
    ...
    public Flowable<TokenRewardPaidEventResponse> tokenRewardPaidEventFlowable(EthFilter filter) {
        return web3j.ethLogFlowable(filter).map(log -> getTokenRewardPaidEventFromLog(log));
    }

    public Flowable<TokenRewardPaidEventResponse> tokenRewardPaidEventFlowable(DefaultBlockParameter startBlock, DefaultBlockParameter endBlock) {
        EthFilter filter = new EthFilter(startBlock, endBlock, getContractAddress());
        filter.addSingleTopic(EventEncoder.encode(TOKENREWARDPAID_EVENT));
        return tokenRewardPaidEventFlowable(filter);
    }

    public static List<TokenStakedEventResponse> getTokenStakedEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = staticExtractEventParametersWithLog(TOKENSTAKED_EVENT, transactionReceipt);
        ArrayList<TokenStakedEventResponse> responses = new ArrayList<TokenStakedEventResponse>(valueList.size());
        for (Contract.EventValuesWithLog eventValues : valueList) {
            TokenStakedEventResponse typedResponse = new TokenStakedEventResponse();
            typedResponse.log = eventValues.getLog();
            typedResponse.stakerId = (Bytes32) eventValues.getIndexedValues().get(0);
            typedResponse.entityId = (Bytes32) eventValues.getNonIndexedValues().get(0);
            typedResponse.tokenId = (Bytes32) eventValues.getNonIndexedValues().get(1);
    ...
    public static TokenStakedEventResponse getTokenStakedEventFromLog(Log log) {
        Contract.EventValuesWithLog eventValues = staticExtractEventParametersWithLog(TOKENSTAKED_EVENT, log);
        TokenStakedEventResponse typedResponse = new TokenStakedEventResponse();
        typedResponse.log = log;
        typedResponse.stakerId = (Bytes32) eventValues.getIndexedValues().get(0);
        typedResponse.entityId = (Bytes32) eventValues.getNonIndexedValues().get(0);
    ...
    public Flowable<TokenStakedEventResponse> tokenStakedEventFlowable(EthFilter filter) {
        return web3j.ethLogFlowable(filter).map(log -> getTokenStakedEventFromLog(log));
    }

    public Flowable<TokenStakedEventResponse> tokenStakedEventFlowable(DefaultBlockParameter startBlock, DefaultBlockParameter endBlock) {
        EthFilter filter = new EthFilter(startBlock, endBlock, getContractAddress());
        filter.addSingleTopic(EventEncoder.encode(TOKENSTAKED_EVENT));
        return tokenStakedEventFlowable(filter);
    }

    public static List<TokenStakingStartedEventResponse> getTokenStakingStartedEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = staticExtractEventParametersWithLog(TOKENSTAKINGSTARTED_EVENT, transactionReceipt);
        ArrayList<TokenStakingStartedEventResponse> responses = new ArrayList<TokenStakingStartedEventResponse>(valueList.size());
        for (Contract.EventValuesWithLog eventValues : valueList) {
            TokenStakingStartedEventResponse typedResponse = new TokenStakingStartedEventResponse();
            typedResponse.log = eventValues.getLog();
            typedResponse.entityId = (Bytes32) eventValues.getIndexedValues().get(0);
            typedResponse.tokenId = (Bytes32) eventValues.getNonIndexedValues().get(0);
            typedResponse.initDate = (Uint256) eventValues.getNonIndexedValues().get(1);
            typedResponse.a = (Uint64) eventValues.getNonIndexedValues().get(2);
            typedResponse.r = (Uint64) eventValues.getNonIndexedValues().get(3);
            typedResponse.divider = (Uint64) eventValues.getNonIndexedValues().get(4);
            typedResponse.interval = (Uint64) eventValues.getNonIndexedValues().get(5);
            responses.add(typedResponse);
        }
        return responses;
    }

    public static TokenStakingStartedEventResponse getTokenStakingStartedEventFromLog(Log log) {
        Contract.EventValuesWithLog eventValues = staticExtractEventParametersWithLog(TOKENSTAKINGSTARTED_EVENT, log);
        TokenStakingStartedEventResponse typedResponse = new TokenStakingStartedEventResponse();
        typedResponse.log = log;
        typedResponse.entityId = (Bytes32) eventValues.getIndexedValues().get(0);
        typedResponse.tokenId = (Bytes32) eventValues.getNonIndexedValues().get(0);
    ...
    public Flowable<TokenStakingStartedEventResponse> tokenStakingStartedEventFlowable(EthFilter filter) {
        return web3j.ethLogFlowable(filter).map(log -> getTokenStakingStartedEventFromLog(log));
    }

    public Flowable<TokenStakingStartedEventResponse> tokenStakingStartedEventFlowable(DefaultBlockParameter startBlock, DefaultBlockParameter endBlock) {
        EthFilter filter = new EthFilter(startBlock, endBlock, getContractAddress());
        filter.addSingleTopic(EventEncoder.encode(TOKENSTAKINGSTARTED_EVENT));
        return tokenStakingStartedEventFlowable(filter);
    }

    public static List<TokenUnstakedEventResponse> getTokenUnstakedEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = staticExtractEventParametersWithLog(TOKENUNSTAKED_EVENT, transactionReceipt);
        ArrayList<TokenUnstakedEventResponse> responses = new ArrayList<TokenUnstakedEventResponse>(valueList.size());
        for (Contract.EventValuesWithLog eventValues : valueList) {
            TokenUnstakedEventResponse typedResponse = new TokenUnstakedEventResponse();
            typedResponse.log = eventValues.getLog();
            typedResponse.stakerId = (Bytes32) eventValues.getIndexedValues().get(0);
            typedResponse.entityId = (Bytes32) eventValues.getNonIndexedValues().get(0);
            typedResponse.tokenId = (Bytes32) eventValues.getNonIndexedValues().get(1);
    ...
    public static TokenUnstakedEventResponse getTokenUnstakedEventFromLog(Log log) {
        Contract.EventValuesWithLog eventValues = staticExtractEventParametersWithLog(TOKENUNSTAKED_EVENT, log);
        TokenUnstakedEventResponse typedResponse = new TokenUnstakedEventResponse();
        typedResponse.log = log;
        typedResponse.stakerId = (Bytes32) eventValues.getIndexedValues().get(0);
        typedResponse.entityId = (Bytes32) eventValues.getNonIndexedValues().get(0);
    ...
    public Flowable<TokenUnstakedEventResponse> tokenUnstakedEventFlowable(EthFilter filter) {
        return web3j.ethLogFlowable(filter).map(log -> getTokenUnstakedEventFromLog(log));
    }

    public Flowable<TokenUnstakedEventResponse> tokenUnstakedEventFlowable(DefaultBlockParameter startBlock, DefaultBlockParameter endBlock) {
        EthFilter filter = new EthFilter(startBlock, endBlock, getContractAddress());
        filter.addSingleTopic(EventEncoder.encode(TOKENUNSTAKED_EVENT));
        return tokenUnstakedEventFlowable(filter);
    }
    ...
    public static List<MinimumSellUpdatedEventResponse> getMinimumSellUpdatedEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = staticExtractEventParametersWithLog(MINIMUMSELLUPDATED_EVENT, transactionReceipt);
        ArrayList<MinimumSellUpdatedEventResponse> responses = new ArrayList<MinimumSellUpdatedEventResponse>(valueList.size());
        for (Contract.EventValuesWithLog eventValues : valueList) {
            MinimumSellUpdatedEventResponse typedResponse = new MinimumSellUpdatedEventResponse();
            typedResponse.log = eventValues.getLog();
            typedResponse.objectId = (Bytes32) eventValues.getNonIndexedValues().get(0);
            typedResponse.minimumSell = (Uint256) eventValues.getNonIndexedValues().get(1);
            responses.add(typedResponse);
        }
        return responses;
    }

    public static MinimumSellUpdatedEventResponse getMinimumSellUpdatedEventFromLog(Log log) {
        Contract.EventValuesWithLog eventValues = staticExtractEventParametersWithLog(MINIMUMSELLUPDATED_EVENT, log);
        MinimumSellUpdatedEventResponse typedResponse = new MinimumSellUpdatedEventResponse();
        typedResponse.log = log;
        typedResponse.objectId = (Bytes32) eventValues.getNonIndexedValues().get(0);
        typedResponse.minimumSell = (Uint256) eventValues.getNonIndexedValues().get(1);
    ...
    public Flowable<MinimumSellUpdatedEventResponse> minimumSellUpdatedEventFlowable(EthFilter filter) {
        return web3j.ethLogFlowable(filter).map(log -> getMinimumSellUpdatedEventFromLog(log));
    }

    public Flowable<MinimumSellUpdatedEventResponse> minimumSellUpdatedEventFlowable(DefaultBlockParameter startBlock, DefaultBlockParameter endBlock) {
        EthFilter filter = new EthFilter(startBlock, endBlock, getContractAddress());
        filter.addSingleTopic(EventEncoder.encode(MINIMUMSELLUPDATED_EVENT));
        return minimumSellUpdatedEventFlowable(filter);
    }
    ...
    public static List<OrderMatchedEventResponse> getOrderMatchedEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = staticExtractEventParametersWithLog(ORDERMATCHED_EVENT, transactionReceipt);
        ArrayList<OrderMatchedEventResponse> responses = new ArrayList<OrderMatchedEventResponse>(valueList.size());
        for (Contract.EventValuesWithLog eventValues : valueList) {
            OrderMatchedEventResponse typedResponse = new OrderMatchedEventResponse();
            typedResponse.log = eventValues.getLog();
            typedResponse.orderId = (Uint256) eventValues.getIndexedValues().get(0);
            typedResponse.matchedWithId = (Uint256) eventValues.getNonIndexedValues().get(0);
            typedResponse.sellAmountMatched = (Uint256) eventValues.getNonIndexedValues().get(1);
            typedResponse.buyAmountMatched = (Uint256) eventValues.getNonIndexedValues().get(2);
            responses.add(typedResponse);
        }
        return responses;
    }

    public static OrderMatchedEventResponse getOrderMatchedEventFromLog(Log log) {
        Contract.EventValuesWithLog eventValues = staticExtractEventParametersWithLog(ORDERMATCHED_EVENT, log);
        OrderMatchedEventResponse typedResponse = new OrderMatchedEventResponse();
        typedResponse.log = log;
        typedResponse.orderId = (Uint256) eventValues.getIndexedValues().get(0);
        typedResponse.matchedWithId = (Uint256) eventValues.getNonIndexedValues().get(0);
    ...
    public Flowable<OrderMatchedEventResponse> orderMatchedEventFlowable(EthFilter filter) {
        return web3j.ethLogFlowable(filter).map(log -> getOrderMatchedEventFromLog(log));
    }

    public Flowable<OrderMatchedEventResponse> orderMatchedEventFlowable(DefaultBlockParameter startBlock, DefaultBlockParameter endBlock) {
        EthFilter filter = new EthFilter(startBlock, endBlock, getContractAddress());
        filter.addSingleTopic(EventEncoder.encode(ORDERMATCHED_EVENT));
        return orderMatchedEventFlowable(filter);
    }
    ...
    public static List<FeeScheduleAddedEventResponse> getFeeScheduleAddedEvents(TransactionReceipt transactionReceipt) {
        ...
        for (Contract.EventValuesWithLog eventValues : valueList) {
            ...
            typedResponse.log = eventValues.getLog();
            typedResponse.entityId = (Bytes32) eventValues.getNonIndexedValues().get(0);
            typedResponse.feeType = (Uint256) eventValues.getNonIndexedValues().get(1);
    ...
    public static List<FeeScheduleRemovedEventResponse> getFeeScheduleRemovedEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = staticExtractEventParametersWithLog(FEESCHEDULEREMOVED_EVENT, transactionReceipt);
        ArrayList<FeeScheduleRemovedEventResponse> responses = new ArrayList<FeeScheduleRemovedEventResponse>(valueList.size());
        for (Contract.EventValuesWithLog eventValues : valueList) {
            FeeScheduleRemovedEventResponse typedResponse = new FeeScheduleRemovedEventResponse();
            typedResponse.log = eventValues.getLog();
            typedResponse.entityId = (Bytes32) eventValues.getNonIndexedValues().get(0);
            typedResponse.feeType = (Uint256) eventValues.getNonIndexedValues().get(1);
            responses.add(typedResponse);
    ...
    public static FeeScheduleRemovedEventResponse getFeeScheduleRemovedEventFromLog(Log log) {
        Contract.EventValuesWithLog eventValues = staticExtractEventParametersWithLog(FEESCHEDULEREMOVED_EVENT, log);
        FeeScheduleRemovedEventResponse typedResponse = new FeeScheduleRemovedEventResponse();
        typedResponse.log = log;
        typedResponse.entityId = (Bytes32) eventValues.getNonIndexedValues().get(0);
        typedResponse.feeType = (Uint256) eventValues.getNonIndexedValues().get(1);
    ...
    public Flowable<FeeScheduleRemovedEventResponse> feeScheduleRemovedEventFlowable(EthFilter filter) {
        return web3j.ethLogFlowable(filter).map(log -> getFeeScheduleRemovedEventFromLog(log));
    }

    public Flowable<FeeScheduleRemovedEventResponse> feeScheduleRemovedEventFlowable(DefaultBlockParameter startBlock, DefaultBlockParameter endBlock) {
        EthFilter filter = new EthFilter(startBlock, endBlock, getContractAddress());
        filter.addSingleTopic(EventEncoder.encode(FEESCHEDULEREMOVED_EVENT));
        return feeScheduleRemovedEventFlowable(filter);
    }
    ...
    public static List<ObjectMinimumSellUpdatedEventResponse> getObjectMinimumSellUpdatedEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = staticExtractEventParametersWithLog(OBJECTMINIMUMSELLUPDATED_EVENT, transactionReceipt);
        ArrayList<ObjectMinimumSellUpdatedEventResponse> responses = new ArrayList<ObjectMinimumSellUpdatedEventResponse>(valueList.size());
        for (Contract.EventValuesWithLog eventValues : valueList) {
            ObjectMinimumSellUpdatedEventResponse typedResponse = new ObjectMinimumSellUpdatedEventResponse();
            typedResponse.log = eventValues.getLog();
            typedResponse.objectId = (Bytes32) eventValues.getNonIndexedValues().get(0);
            typedResponse.newMinimumSell = (Uint256) eventValues.getNonIndexedValues().get(1);
            responses.add(typedResponse);
        }
        return responses;
    }

    public static ObjectMinimumSellUpdatedEventResponse getObjectMinimumSellUpdatedEventFromLog(Log log) {
        Contract.EventValuesWithLog eventValues = staticExtractEventParametersWithLog(OBJECTMINIMUMSELLUPDATED_EVENT, log);
        ObjectMinimumSellUpdatedEventResponse typedResponse = new ObjectMinimumSellUpdatedEventResponse();
        typedResponse.log = log;
        typedResponse.objectId = (Bytes32) eventValues.getNonIndexedValues().get(0);
        typedResponse.newMinimumSell = (Uint256) eventValues.getNonIndexedValues().get(1);
    ...
    public Flowable<ObjectMinimumSellUpdatedEventResponse> objectMinimumSellUpdatedEventFlowable(EthFilter filter) {
        return web3j.ethLogFlowable(filter).map(log -> getObjectMinimumSellUpdatedEventFromLog(log));
    }

    public Flowable<ObjectMinimumSellUpdatedEventResponse> objectMinimumSellUpdatedEventFlowable(DefaultBlockParameter startBlock, DefaultBlockParameter endBlock) {
        EthFilter filter = new EthFilter(startBlock, endBlock, getContractAddress());
        filter.addSingleTopic(EventEncoder.encode(OBJECTMINIMUMSELLUPDATED_EVENT));
        return objectMinimumSellUpdatedEventFlowable(filter);
    }

    public static List<SelfOnboardingApprovedEventResponse> getSelfOnboardingApprovedEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = staticExtractEventParametersWithLog(SELFONBOARDINGAPPROVED_EVENT, transactionReceipt);
        ArrayList<SelfOnboardingApprovedEventResponse> responses = new ArrayList<SelfOnboardingApprovedEventResponse>(valueList.size());
        for (Contract.EventValuesWithLog eventValues : valueList) {
            SelfOnboardingApprovedEventResponse typedResponse = new SelfOnboardingApprovedEventResponse();
            typedResponse.log = eventValues.getLog();
    ...
    public static SelfOnboardingApprovedEventResponse getSelfOnboardingApprovedEventFromLog(Log log) {
        Contract.EventValuesWithLog eventValues = staticExtractEventParametersWithLog(SELFONBOARDINGAPPROVED_EVENT, log);
        SelfOnboardingApprovedEventResponse typedResponse = new SelfOnboardingApprovedEventResponse();
        typedResponse.log = log;
        typedResponse.userAddress = (Address) eventValues.getIndexedValues().get(0);
        return typedResponse;
    ...
    public Flowable<SelfOnboardingApprovedEventResponse> selfOnboardingApprovedEventFlowable(EthFilter filter) {
        return web3j.ethLogFlowable(filter).map(log -> getSelfOnboardingApprovedEventFromLog(log));
    }

    public Flowable<SelfOnboardingApprovedEventResponse> selfOnboardingApprovedEventFlowable(DefaultBlockParameter startBlock, DefaultBlockParameter endBlock) {
        EthFilter filter = new EthFilter(startBlock, endBlock, getContractAddress());
        filter.addSingleTopic(EventEncoder.encode(SELFONBOARDINGAPPROVED_EVENT));
        return selfOnboardingApprovedEventFlowable(filter);
    }

    public static List<SelfOnboardingCancelledEventResponse> getSelfOnboardingCancelledEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = staticExtractEventParametersWithLog(SELFONBOARDINGCANCELLED_EVENT, transactionReceipt);
        ArrayList<SelfOnboardingCancelledEventResponse> responses = new ArrayList<SelfOnboardingCancelledEventResponse>(valueList.size());
        for (Contract.EventValuesWithLog eventValues : valueList) {
            SelfOnboardingCancelledEventResponse typedResponse = new SelfOnboardingCancelledEventResponse();
            typedResponse.log = eventValues.getLog();
            typedResponse.userAddress = (Address) eventValues.getIndexedValues().get(0);
            responses.add(typedResponse);
        }
    ...
    public static SelfOnboardingCancelledEventResponse getSelfOnboardingCancelledEventFromLog(Log log) {
        Contract.EventValuesWithLog eventValues = staticExtractEventParametersWithLog(SELFONBOARDINGCANCELLED_EVENT, log);
        SelfOnboardingCancelledEventResponse typedResponse = new SelfOnboardingCancelledEventResponse();
        typedResponse.log = log;
        typedResponse.userAddress = (Address) eventValues.getIndexedValues().get(0);
        return typedResponse;
    ...
    public Flowable<SelfOnboardingCancelledEventResponse> selfOnboardingCancelledEventFlowable(EthFilter filter) {
        return web3j.ethLogFlowable(filter).map(log -> getSelfOnboardingCancelledEventFromLog(log));
    }

    public Flowable<SelfOnboardingCancelledEventResponse> selfOnboardingCancelledEventFlowable(DefaultBlockParameter startBlock, DefaultBlockParameter endBlock) {
        EthFilter filter = new EthFilter(startBlock, endBlock, getContractAddress());
        filter.addSingleTopic(EventEncoder.encode(SELFONBOARDINGCANCELLED_EVENT));
        return selfOnboardingCancelledEventFlowable(filter);
    }

    public static List<SelfOnboardingCompletedEventResponse> getSelfOnboardingCompletedEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = staticExtractEventParametersWithLog(SELFONBOARDINGCOMPLETED_EVENT, transactionReceipt);
        ArrayList<SelfOnboardingCompletedEventResponse> responses = new ArrayList<SelfOnboardingCompletedEventResponse>(valueList.size());
        for (Contract.EventValuesWithLog eventValues : valueList) {
            SelfOnboardingCompletedEventResponse typedResponse = new SelfOnboardingCompletedEventResponse();
            typedResponse.log = eventValues.getLog();
            typedResponse.userAddress = (Address) eventValues.getIndexedValues().get(0);
            responses.add(typedResponse);
        }
    ...
    public static SelfOnboardingCompletedEventResponse getSelfOnboardingCompletedEventFromLog(Log log) {
        Contract.EventValuesWithLog eventValues = staticExtractEventParametersWithLog(SELFONBOARDINGCOMPLETED_EVENT, log);
        SelfOnboardingCompletedEventResponse typedResponse = new SelfOnboardingCompletedEventResponse();
        typedResponse.log = log;
        typedResponse.userAddress = (Address) eventValues.getIndexedValues().get(0);
        return typedResponse;
    ...
    public Flowable<SelfOnboardingCompletedEventResponse> selfOnboardingCompletedEventFlowable(EthFilter filter) {
        return web3j.ethLogFlowable(filter).map(log -> getSelfOnboardingCompletedEventFromLog(log));
    }

    public Flowable<SelfOnboardingCompletedEventResponse> selfOnboardingCompletedEventFlowable(DefaultBlockParameter startBlock, DefaultBlockParameter endBlock) {
        EthFilter filter = new EthFilter(startBlock, endBlock, getContractAddress());
        filter.addSingleTopic(EventEncoder.encode(SELFONBOARDINGCOMPLETED_EVENT));
        return selfOnboardingCompletedEventFlowable(filter);
    }
    ...
    public static class FeeAllocation extends StaticStruct {
        ...
        public FeeAllocation(Bytes32 to, Uint256 fee, Uint256 basisPoints) {
            super(to, fee, basisPoints);
            this.to = to;
            this.fee = fee;
    ...
    public static class StakingConfig extends StaticStruct {
        public Bytes32 tokenId;

        public Uint256 initDate;

        public Uint64 a;

        public Uint64 r;

        public Uint64 divider;

        public Uint64 interval;

        public StakingConfig(Bytes32 tokenId, Uint256 initDate, Uint64 a, Uint64 r, Uint64 divider, Uint64 interval) {
            super(tokenId, initDate, a, r, divider, interval);
    ...
    public static class ExternalDepositEventResponse extends BaseEventResponse {
        public Bytes32 receiverId;

        public Address externalTokenAddress;

        public Uint256 amount;
    }

    public static class ExternalWithdrawEventResponse extends BaseEventResponse {
    ...
    public static class TokenRewardCollectedEventResponse extends BaseEventResponse {
        public Bytes32 stakerId;
        ...
        public Bytes32 rewardCurrency;

        public Uint256 rewardAmount;
    }

    public static class TokenRewardPaidEventResponse extends BaseEventResponse {
        public Bytes32 guid;
        ...
        public Bytes32 rewardTokenId;

        public Uint256 rewardAmount;
    }

    public static class TokenStakedEventResponse extends BaseEventResponse {
        public Bytes32 stakerId;
    ...
    public static class TokenStakingStartedEventResponse extends BaseEventResponse {
        public Bytes32 entityId;
    ...
    public static class TokenUnstakedEventResponse extends BaseEventResponse {
        public Bytes32 stakerId;
    ...
    public static class MinimumSellUpdatedEventResponse extends BaseEventResponse {
        public Bytes32 objectId;

        public Uint256 minimumSell;
    }
    ...
    public static class OrderMatchedEventResponse extends BaseEventResponse {
        public Uint256 orderId;

        public Uint256 matchedWithId;

        public Uint256 sellAmountMatched;

        public Uint256 buyAmountMatched;
    }
    ...
    public static class FeeScheduleRemovedEventResponse extends BaseEventResponse {
        public Bytes32 entityId;
    ...
    public static class ObjectMinimumSellUpdatedEventResponse extends BaseEventResponse {
        public Bytes32 objectId;

        public Uint256 newMinimumSell;
    }

    public static class SelfOnboardingApprovedEventResponse extends BaseEventResponse {
        public Address userAddress;
    }

    public static class SelfOnboardingCancelledEventResponse extends BaseEventResponse {
        public Address userAddress;
    }

    public static class SelfOnboardingCompletedEventResponse extends BaseEventResponse {
        public Address userAddress;
    }
